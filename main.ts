...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile19`, function (sprite, location) {
    tiles.placeOnRandomTile(crystal_2, assets.tile`myTile19`)
})
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile24`, function (sprite, location) {
    tiles.placeOnRandomTile(mySprite, assets.tile`myTile40`)
})
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile18`, function (sprite, location) {
    tiles.placeOnRandomTile(crystal_1, assets.tile`myTile18`)
})
...
let moving = false
let crystal_4: Sprite = null
let crystal_3: Sprite = null
